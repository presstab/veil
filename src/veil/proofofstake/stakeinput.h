...
public:
    ...
    virtual bool GetModifier(int nChainHeight, uint64_t& nStakeModifier) = 0;
...
public:
    ...
    bool GetModifier(int nChainHeight, uint64_t& nStakeModifier) override;
    ...
    static int HeightToModifierHeight(int nHeightBlock, int nHeightStake);
};
